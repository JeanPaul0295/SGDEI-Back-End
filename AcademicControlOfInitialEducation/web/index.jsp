...
<html>
<head>
  <title>Sgdei-Sistema Gestor de Educación Inicial</title>
...
<div class="header_bg">
  <div class="wrap">
    <div class="header">
      <div class="logo">
        <a href="index.jsp">
          <img src="images/logo web.png" WIDTH=178 HEIGHT=100 />
          <div class="clear"> </div>
        </a>
      </div>
        ...
        <ul id="jquery-demo">
          <li>
            ...
            <div data-scroll-reveal="enter bottom but wait 0.7s" class="slider-detils">
              <h3>Desarrollado por Web devs.</h3>
              <span>El desarrollo nace a partir de la necesidad de contar con un canal entre el apoderado
										y cada institución </span>
            </div>
          </li>
          <li>
            <a href="#slide2">
...
<div class="simple-text">
  <div class="wrap">
    <h4>Establecemos un canal entre el padre de familia y el conjunto de instituciones en la cual sus hijos están matriculados para unificar la información de los mismos.</h4>
...
<div class="Recent-wroks"><!-- start services -->
  <div class="wrap">
    <div class="Recent-wrok">
      <h5 class="heading">Instituciones relacionadas</h5>
      <!----start-img-cursual---->
...
<div class="copy">
  <p>© 2017 Todos los derechos <a href="" target="_blank">Web devs</a></p>
</div>
</body>
</html>